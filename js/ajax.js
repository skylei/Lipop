...
var ajaxignore_string = new String('#, /wp-, .pdf, .zip, .rar, /goto, /?feed'); 
var ajaxignore = ajaxignore_string.split(', ');
var ajaxloading_code = '<div id="errajax"><div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>';

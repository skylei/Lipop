...
function ajax_comment_scripts(){
    wp_enqueue_style( 'ajax-comment', get_template_directory_uri() . '/includes/ajax-comment.css');
    wp_enqueue_script( 'ajax-comment', get_template_directory_uri() . '/includes/ajax-comment.js' );
